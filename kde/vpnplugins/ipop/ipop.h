/* ipop.h - import/export ipop connections
 *
...
class IPOPUiPlugin : public VpnUiPlugin {
Q_OBJECT
public:
    IPOPUiPlugin(QObject * parent = 0, const QVariantList& = QVariantList());
    virtual ~IPOPUiPlugin();
    ...
    bool exportConnectionSettings(Knm::Connection* connection,
