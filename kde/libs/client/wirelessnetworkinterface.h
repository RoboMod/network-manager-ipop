...
#ifndef WIRELESSNETWORKINTERFACE_H
#define WIRELESSNETWORKINTERFACE_H
...
/*
 * Proxy class for interface org.kde.networkmanagement.WirelessNetwork
 */
class WirelessNetworkInterface: public QDBusAbstractInterface
{
    Q_OBJECT
public:
    static inline const char *staticInterfaceName()
    { return "org.kde.networkmanagement.WirelessNetwork"; }

public:
    WirelessNetworkInterface(const QString &service, const QString &path, const QDBusConnection &connection, QObject *parent = 0);
